...
export default function AwardApp({ Component, pageProps }) {
  ...
  const NavItems = [
    ...
    },
    {
      ...
      href: "https://discord.gg/7We7rMRmVa",
    },
    {
      link: true,
      name: "Add Bot",
      ...
      href: "https://discord.com/oauth2/authorize?client_id=1229707669049180161&scope=applications.commands+bot&permissions=414736444608",
    },
       {
      link: true,
      name: "Vote",
      ...
      href: "https://top.gg/bot/1229707669049180161/vote",
    }
  ]
