  ...
  return (
    <div>
     <h2 className="mt-4 text-white font-bold text-3xl">Terms of Services</h2>
      <p className="text-sm text-white/30 mb-1">Last Update: 23/04/2024 🆕️</p>
  <div className="animateHeader text-white text-opacity-40 mt-5">
<p>⊳ Every discord server can use the Coinopolis bot for free, it is completely prohibited to sell or market for a fee.</p>
...
<div className="py-3"></div>
<p>⊳ To use certain discord bot commands, you need to vote for the <a className="text-white" href="https://top.gg/bot/1229707669049180161/vote">Coinopolis</a> bot at certain intervals.</p>
</div>
    </div>
  );
}
